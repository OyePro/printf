#include "main.h"
/**
 * base_16 - prints a decimal in hexadecimal
 * @list: input string
 * @buf: buffer pointer
...
/**
 * base_l16 - prints a long decimal in hexadecimal
 * @list: input string
 * @buf: buffer pointer
 * @ibuf: index for buffer pointer
 * Return: number of chars printed
...
/**
 * base_n16 - print number in hex begining with zero
 * @list: input string
 * @buf: buffer pointer
 * @ibuf: index for buffer pointer
 * Return: number of chars printed
...
/**
 * base_s16 - prints a short decimal in hexadecimal
 * @list: input string
 * @buf: buffer pointer
 * @ibuf: index for buffer pointer
 * Return: number of chars printed
